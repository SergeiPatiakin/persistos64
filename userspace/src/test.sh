...
assert_exit_code 2
set -e
echo 'Files differ, they have different lengths' > td/diff_length.expected
diff td/diff_length.out td/diff_length.expected
...
assert_exit_code 2
set -e
echo 'Files differ' > td/diff_differs.expected
diff td/diff_differs.out td/diff_differs.expected
